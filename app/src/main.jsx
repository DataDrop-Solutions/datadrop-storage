...
function Loader() {
  return (
    <div style={{ display:'flex', alignItems:'center', justifyContent:'center', height:'100vh', background:'#07070D' }}>
      <div style={{ width:26, height:26, border:'2.5px solid #1E1E32', borderTopColor:'#5B5EF4',
